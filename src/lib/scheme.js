    ...
    (t = (function () {
        ...
        for (
            i =
                ...
                t.SCHEMES = {},
                a = "mono monochromatic contrast triade tetrade analogic".split(
                    /\s+/
                ),
                r = 0,
                o = a.length;
        ...
        return (
            ...
            (t.prototype.scheme = function (e) {
                ...
                if (null == t.SCHEMES[e])
                    throw "'" + e + "' isn't a valid scheme name";
